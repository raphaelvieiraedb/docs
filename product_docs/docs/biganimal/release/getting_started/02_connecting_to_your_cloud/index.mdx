...
- You must set permissions to allow BigAnimal to perform maintenance operations in your cloud.
 ...
 - **If connecting to an AWS account, ensure that:** 
   ...
   BigAnimal uses a custom role to provision infrastructure in your AWS cloud account. This role includes permissions for:
 ...
 - **If connecting to an Azure subscription, ensure that:** 
   ...
   BigAnimal uses a custom role to provision infrastructure in your Azure cloud account. This role includes permissions for:

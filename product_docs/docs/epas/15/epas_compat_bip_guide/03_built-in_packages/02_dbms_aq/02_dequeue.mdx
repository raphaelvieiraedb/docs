...
| `navigation`     | Identifies the message to retrieve. Must be either:<br /><br />`FIRST_MESSAGE` – The first message within the queue that matches the search term.<br /><br />`NEXT_MESSAGE` – The next message that is available that matches the first term.                                                                                                                         |

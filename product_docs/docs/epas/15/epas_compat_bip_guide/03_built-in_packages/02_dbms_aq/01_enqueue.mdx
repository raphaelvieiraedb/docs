...
| `delay`             | Specify the number of seconds that to pass before a message is available for dequeueing or `NO_DELAY`.                                                                                                                                                                                                                                               |
| `expiration`        | Use the expiration parameter to specify the number of seconds until a message expires.                                                                                                                                                                                                                                                                 |
| `correlation`       | Use correlation to specify a message that to associate with the entry; the default is `NULL`.                                                                                                                                                                                                                                                    |

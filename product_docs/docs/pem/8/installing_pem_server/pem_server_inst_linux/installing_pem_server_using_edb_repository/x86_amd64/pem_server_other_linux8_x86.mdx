...
For more details, see [Configuring the PEM Server on Linux](https://www.enterprisedb.com/docs/pem/latest/installing_pem_server/pem_server_inst_linux/installing_pem_server_using_edb_repository/x86_amd64/pem_server_other_linux8_x86/).
